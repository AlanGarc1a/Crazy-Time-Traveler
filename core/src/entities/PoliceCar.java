...
public class PoliceCar extends EnemyObject {
    ...
    public PoliceCar(CrazyTimeTraveler game) {
        super(game);

        flyingAnimation = new Animation<TextureRegion>(1 / 15f, atlas2.findRegions(Assets.POLICE_CAR), Animation.PlayMode.LOOP);
        deathAnimation = new Animation<TextureRegion>(1 / 15f, atlas2.findRegions(Assets.POLICE_CAR_DIE));
